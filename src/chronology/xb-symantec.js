module.exports = {
  title:`symantec software roadmap`, 
  link:'https://securitycloud.symantec.com/cc/landing',
  when:'2002',
  stack:['lcms', 'scorm', 'xml'],
  roles: ['principal', 'transformation'],
  body: `
  I worked with the learning group at this leading software manufacturer to create a road map for integrating CBT (Computer Based Training) production with the companies global XML content management system. 
