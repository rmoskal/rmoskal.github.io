module.exports = {
  ...
  body: `
  This "startup" within PWVC moved rapidly to create a new generation of software for field service and retail sales organizations. The goal was to replace behemoths like Great Plains and home grown systems with modern applications that utilized technologies such as big data, machine learning, and conversational interfaces.

  Initially, I was to identify and cultivate commonalities across the efforts of a large and heterogeneous group of principals in a fast moving environment.
