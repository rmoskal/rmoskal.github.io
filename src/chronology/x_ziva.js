module.exports = {
  ...
  Thorough unit test coverage ensured deep changes could be made to the system in response to fluid and ill defined customer requirements. Our continued reliance on lightweight J2EE development helped mitigate the risks of a large, heterogeneous development effort. The Spring framework greatly simplified application configuration and integration of different principal contributions. We used its aspect oriented features to greatly reduce the amount of code we had to write. The latest version of Hibernate handled the task of mapping objects to the postgres database and eliminated the need to create separate mapping files.
