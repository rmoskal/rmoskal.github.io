module.exports = {
  ...
  I built the server side of the application using python. On the app engine, it's all about minimizing the resources used. The super lightweight flask micro-framework provided just the features we needed. Our API put most of the business logic in the javascript client, allowing for the game rules to evolve without needing changes to the back-end.
